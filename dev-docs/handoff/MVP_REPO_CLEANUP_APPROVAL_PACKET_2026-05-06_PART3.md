...
- [MVP_REFACTOR_HANDOFF_2026-05-06.md](/Users/pa/projects/funcup/dev-docs/handoff/MVP_REFACTOR_HANDOFF_2026-05-06.md)
...
- część z nich dubluje lub poprzedza aktualniejsze dokumenty w `dev-docs/handoff`, audit i ADR-y

### Aktywny odpowiednik

- bieżący kierunek MVP i cleanup:
  - `dev-docs/Zadanie MVP refactor.md`
  - `dev-docs/funcup-web-mobile-data-flow-audit.md`
  - `dev-docs/handoff/MVP_REFACTOR_HANDOFF_2026-05-06.md`
- decyzje modelowe:
  - `dev-docs/specs/002-qr-coffee-platform/adrs/012-canonical-product-model.md`
...
- to ryzyko jest akceptowalne, bo nadal pozostaną w repo pod `archive/prompts/`, ale przestaną udawać aktywną warstwę dokumentacji
...
## Group F — `dev-docs/Stage UI prompts/*`
...
- `dev-docs/Stage UI prompts/QR GENERATE ROASTER – CAL AND UPLOAD.md`
- `dev-docs/Stage UI prompts/create-roaster-hub.md`
- `dev-docs/Stage UI prompts/create-roaster-profile-page.md`
- `dev-docs/Stage UI prompts/qr gen prompt 2.md`
- `dev-docs/Stage UI prompts/qr-code-roaster-coffee-tag-calendar.md`
- `dev-docs/Stage UI prompts/qr-code-roaster-session.md`
- `dev-docs/Stage UI prompts/qr-generate-roaster.md`
- `dev-docs/Stage UI prompts/qr-scan-consumer.md`
...
- `dev-docs/Stage UI prompts/` wygląda jak aktywna dokumentacja produktu, ale w praktyce jest kolekcją starych promptów operatorskich
...
- aktywna implementacja tych flow jest w:
  ...
  - `apps/web/app/roaster-hub/*`
  - `apps/web/app/roaster-profile/page.tsx`
  - `apps/web/app/api/qr/route.ts`
  - `apps/consumer-mobile/app/q/[hash].tsx`
  - `packages/shared/src/hooks/useCoffeePage.ts`
  - `supabase/functions/scan_qr/index.ts`

### Proponowana decyzja

- przenieść cały katalog `dev-docs/Stage UI prompts/` do:
  - `archive/prompts/stage-ui/`
- zachować wszystkie pliki jako historyczne reference prompts

### Ryzyko / uwagi

- stare linki lub rozmowy odwołujące się do `dev-docs/Stage UI prompts/*` przestaną wskazywać aktywne miejsce
...
- pusty katalog `dev-docs/Stage UI prompts/` został usunięty
