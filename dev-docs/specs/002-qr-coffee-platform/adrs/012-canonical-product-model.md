...
## Context
Audit `dev-docs/funcup-web-mobile-data-flow-audit.md` confirmed that funcup currently runs two active but divergent product models:
...
- `dev-docs/funcup-src-docs/02-specs/spec.md`
