...
To wynika wprost z:
- specyfikacji MVP w [spec.md](/Users/pa/projects/funcup/dev-docs/funcup-src-docs/02-specs/spec.md)
- backlogu 88 tasków w [13-tasks-002-qr-coffee-platform-88-tasks.md](/Users/pa/projects/funcup/dev-docs/funcup-src-docs/04-tasks/13-tasks-002-qr-coffee-platform-88-tasks.md)
- audytu przepływów w [funcup-web-mobile-data-flow-audit.md](/Users/pa/projects/funcup/dev-docs/funcup-web-mobile-data-flow-audit.md)
...
8. **Dopiero potem wejść w Phase 010**
   - Backlog z [14-tasks-003-phase-010-product-ux-ui-backlog.md](/Users/pa/projects/funcup/dev-docs/funcup-src-docs/04-tasks/14-tasks-003-phase-010-product-ux-ui-backlog.md) ma sens dopiero po unifikacji modelu.
