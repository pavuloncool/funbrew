...
const targets = [
  ...
  'apps/consumer-mobile/src/components',
  'apps/consumer-mobile/src/theme',
];

const allowList = new Set([
  'apps/consumer-mobile/src/components/entry/entrySvgXml.ts',
  'apps/consumer-mobile/src/components/entry/MobileEntrySplash.tsx',
  'apps/consumer-mobile/src/components/entry/MobileEntrySplash.styles.ts',
