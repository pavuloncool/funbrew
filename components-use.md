...
## Cel
Ten dokument opisuje, jak stosować nową warstwę wizualną opartą o `@funcup/shared` oraz prymitywy mobile z `apps/consumer-mobile/src/components/ui/primitives.tsx`.

## Źródło prawdy
- Tokeny i role: `packages/shared/src/visualSystem.ts`
- Kompatybilność legacy: `packages/shared/src/visualTokens.ts`
- Prymitywy RN: `apps/consumer-mobile/src/components/ui/primitives.tsx`
- Tabbar shell: `apps/consumer-mobile/src/components/ui/AppTabBar.tsx`
