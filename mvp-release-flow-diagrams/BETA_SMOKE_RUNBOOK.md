...
Date: 2026-05-09  
Main script: `scripts/beta-smoke-tests.sh`  
Aux script: `scripts/mobile-functions-smoke-check.sh`  
Contract reference: `mvp-release-flow-diagrams/BETA_INTEGRATION_CONTRACT.md`
