...
- backlog Phase 010 ma stale references do `apps/frontend` i mobile `/home`
...
- nie przywracaj `apps/frontend`, `/home`, `test-select-user` ani innych zarchiwizowanych scaffoldów
