...
- `dev-docs/handoff/PHASE010_RESTART_HANDOFF_2026-05-06.md`
- `dev-docs/handoff/PHASE010_NEW_CHAT_PROMPT_2026-05-06.md`
- `dev-docs/funcup-src-docs/04-tasks/14-tasks-003-phase-010-product-ux-ui-backlog.md`
- `dev-docs/funcup-src-docs/02-specs/08-entry-ux-spec-fr012.md`
- `dev-docs/Zadanie MVP refactor.md`

Ważne źródła prawdy:

- backlog Phase 010 jest source of truth dla pozostałych tasków
- aktywna rzeczywistość repo nie używa `apps/frontend`, mobile `/home`, `test-select-user`
- roaster only on web
...
- jeden spójny kierunek tokenów między `packages/shared`, mobile i web
...
- `pnpm -C apps/web dev --hostname 0.0.0.0 --port 3000` lub alternatywny wolny port
...
- nie przywracaj `apps/frontend`, `/home`, `test-select-user`
