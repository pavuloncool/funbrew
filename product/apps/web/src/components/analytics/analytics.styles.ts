...
export const analyticsStyles = {
  ...
  statGridTelemetry: 'mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6',
  ...
  pillMatch: 'border-vs-accent-primary bg-vs-accent-primary/10 text-vs-text-primary',
  pillMissing: 'border-vs-warning bg-vs-warning/10 text-vs-text-primary',
  pillUnexpected: 'border-vs-hero-primary bg-vs-hero-primary/10 text-vs-text-primary',
  compareColumns: 'mt-6 grid gap-4 lg:grid-cols-2',
  compareBlock: 'rounded-vs-sm border border-vs-border-subtle/40 bg-vs-surface px-4 py-4',
  compareBlockStacked: 'mt-4 rounded-vs-sm border border-vs-border-subtle/40 bg-vs-surface px-4 py-4',
