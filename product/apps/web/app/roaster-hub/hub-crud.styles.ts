...
export const hubCrudStyles = {
  main760: 'mx-auto w-full max-w-[1240px] px-6 py-10 font-sans text-vs-text-primary',
  main480: 'mx-auto w-full max-w-[560px] px-6 py-10 font-sans text-vs-text-primary',
  navBack: 'mb-5 inline-flex items-center text-xl font-semibold text-vs-text-primary underline underline-offset-4',
  ...
  submitBtn:
    'vs-button-primary px-6 py-2 text-base font-semibold',
  error: 'mt-3 text-sm text-vs-danger',
  muted: 'text-base text-vs-text-secondary',
  title: 'font-display text-4xl uppercase tracking-[-0.03em] text-vs-text-primary',
  titleSetup: 'mb-2 font-display text-4xl uppercase tracking-[-0.03em] text-vs-text-primary',
  ...
  pageHeading: 'mb-5 font-display text-5xl uppercase tracking-[-0.03em] text-vs-text-primary',
  list: 'list-disc space-y-1 pl-5 text-base',
  actionLink: 'vs-button-secondary inline-block px-5 py-2 text-base font-semibold',
} as const;
