...
export const hubCrudStyles = {
  ...
  assetPreviewFrame: 'mt-2 flex h-28 w-28 items-center justify-center overflow-hidden rounded-vs-md border-2 border-vs-border-strong bg-vs-surface shadow-vs-sm',
